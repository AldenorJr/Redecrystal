...
| **Arena aberta a todos; clã sem proteção — DECIDIDO** | **Qualquer** jogador entra na arena (respeitado só o cap ~200); **não** há restrição por clã. Membros do **mesmo clã** entram e lutam de forma **independente** — a arena é **free-for-all**, **sem** proteção/friendly-fire de clã: um jogador pode matar qualquer um, inclusive companheiros de clã, e **ganha o kill reward** normalmente. Sem times/party. (Clã, Fase 17, não altera o combate da arena.) |
